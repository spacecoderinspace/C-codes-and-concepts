#include <iostream>
#include <exception> // Include for standard exception handling
using namespace std;

// Custom exception class inheriting publicly from std::exception
class MyException : public exception {
public:
    // Override what() function to provide a custom message
...
int main() {
    ...
    catch (const MyException& e) { // Catch exception by reference
        cout << e.what() << '\n';  // Print custom message from what()
    }
    return 0;
}
